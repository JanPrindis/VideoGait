        ...
        if not self.tracking:
            ...
            for i, kpts in enumerate(keypoints):
                ...
                if track_id > -1:
                    ...
                    bboxes_current_frame.append(bbox)
                    kpts_current_frame.append(kpts)
                    scores_current_frame.append(scores[i])

            keypoints = np.array(kpts_current_frame)
            scores = np.array(scores_current_frame)
